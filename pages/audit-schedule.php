                    ...
                    <td>
                        <a class="badge text-bg-primary text-decoration-none me-2" style="font-size: 14px; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#scheduleModal">
                            <div class="position-relative">
                                ...
                                <span class="position-absolute bottom-0 end-50 translate-middle" style="font-size: 10px; margin-bottom: -5%; margin-right: 60% !important;"><i class="bi bi-clock-history"></i></span>  &nbsp;Reschedule Audit
                            </div>
                        </a>
                    </td>                    
                </tr>
