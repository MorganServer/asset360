...
<head>
    ...
    <title>Network Devices | Asset360</title>
</head>
<body>
    ...
    <!-- main-container -->
        <div class="container" style="padding: 0 75px 0 75px;">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM assets WHERE asset_type = 'Network Device' ORDER BY asset_created DESC LIMIT $limit OFFSET $offset";
        ...
        <?php
            // Pagination links
            $sql = "SELECT COUNT(*) as total FROM assets WHERE asset_type = 'Network Device'";
            $result = mysqli_query($conn, $sql);
