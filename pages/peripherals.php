...
<head>
    ...
    <title>Peripherials | Asset360</title>
</head>
<body>
    ...
    <div class="container" style="padding: 0 75px 0 75px;">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM assets WHERE asset_type = 'Peripheral' ORDER BY asset_created DESC LIMIT $limit OFFSET $offset";
        ...
        <?php
            // Pagination links
            $sql = "SELECT COUNT(*) as total FROM assets WHERE asset_type = 'Peripheral'";
            $result = mysqli_query($conn, $sql);
