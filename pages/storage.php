...
<head>
    ...
    <title>Storage Devices | Asset360</title>
</head>
<body>
    ...
    <div class="container" style="padding: 0 75px 0 75px;">
            ...
            $sql = "SELECT * FROM assets WHERE asset_type = 'Storage Device' ORDER BY asset_created DESC LIMIT $limit OFFSET $offset";
        ...
        <?php
            // Pagination links
            $sql = "SELECT COUNT(*) as total FROM assets WHERE asset_type = 'Storage Device'";
            $result = mysqli_query($conn, $sql);
