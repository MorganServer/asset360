        ...
        <!-- end php code for getting asset details -->
                ...
                <h2>
                    ...
                    <span class="float-end d-flex">
                        ...
                        <!-- JIRA BUTTON -->
                            <a class="badge text-bg-primary text-decoration-none" style="font-size: 14px; cursor: pointer;" id="createTicketButton"><i class="bi bi-shield-fill-check icon_rotate"></i> &nbsp;Perform Aduit</a>
