        ...
        <div class="card-body ps-2">
            ...
            <div class="row ms-3 justify-content-between" style="max-width: 96% !important;">
                <div class="col-sm-6 col-md-4 col-lg-4 mb-3">
                    <div class="card" style="max-width: 100px;border-top: 4px solid gray; border-radius: 3px !important;">
                        <div class="card-body">
            ...
            <div class="row ms-3">
                <div class="col">
                    <div class="card" style="width: 97%; border-top: 4px solid red; border-radius: 3px !important;">
                        <div class="card-body">
